...
### scala.reflect.internal.FatalError: 
  ThisType(method clearOneLine) for sym which is not a class
  ...
  last tree to typer: Ident(_CURSOR_cond)
...
== Source file context for tree position ==
   ...
   152         if(col > gridDims.height - 1){
   153             currBoard
   154         }else{
   155             val nBoard : Map[Point, CellType] = clearOneLine(currBoard,col, _CURSOR_cond)
   156         }
   157     }
   158 

...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(Empty)
       tree position: line 135 of file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala
...
== Source file context for tree position ==
   ...
   132     //use this only for setted pieces
   133     def checkOneLine(y : Int) : Boolean = {
   134         _CURSOR_newBoard.filter{ case(Point(_,col),_) => col == y
   135         }.forall{case (_, ctype) => ctype != Empty}
   136     }
   137     def checkAllLines() : Map[Int,Boolean] = {
   138         val linesToRemove : Map[Int, Boolean] = (for {

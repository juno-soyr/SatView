...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_pieceType)
       tree position: line 49 of file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala
            tree tpe: <error>
              symbol: value <error: <none>>
   symbol definition: val <error: <none>>: <error> (a TermSymbol)
      symbol package: tetris.logic
       symbol owners: value <error: <none>> -> value pieceType -> method newGameState -> class GameState
...
== Source file context for tree position ==
    ...
    47 
    48 
    49     def newGameState(board : Map[Point,CellType], currentPosition : List[Point] = currentPosition ,pieceType : CellType = _CURSOR_pieceType, newPiece : Boolean = newPiece) : GameState = {
    50         return new GameState(randomGen, board, newPiece ,newPieceFlag)
    51     }
    52 }

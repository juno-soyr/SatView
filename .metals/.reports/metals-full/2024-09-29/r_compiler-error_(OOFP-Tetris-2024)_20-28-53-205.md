  ...
  last tree to typer: Ident(_CURSOR_currentPosition)
   ...
   symbol definition: val <error: <none>>: <error> (a TermSymbol)
      symbol package: tetris.logic
       symbol owners: value <error: <none>> -> value currentPosition -> method newGameState -> class GameState
...
== Source file context for tree position ==
    ...
    47 
    48 
    49     def newGameState(board : Map[Point,CellType], currentPosition : List[Point] = _CURSOR_currentPosition ,pieceType : CellType = pieceType, newPiece : Boolean = newPiece) : GameState = {

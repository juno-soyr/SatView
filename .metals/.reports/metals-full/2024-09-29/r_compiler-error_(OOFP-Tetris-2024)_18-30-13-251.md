...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(Empty)
       tree position: line 44 of file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala
...
== Source file context for tree position ==
    ...
    41                 //println(piece.cell)
    42                 key -> _CURSOR_piece.blockType
    43             }else{
    44                 key -> Empty
    45             }
    46     }.toMap
...
class GameState(val randomGen : RandomGenerator, val board : Map[(Int,Int), CellType], val currentPosition : List[Point] = List(), val pieceType : CellType = Empty,val newPiece : Boolean = false){
    ...
    if(newPiece){
        ...
        val piece : Tetronimo = new Tetronimo(currentPosition,pieceType)
    }
    ...
    def newGameState(board : Map[(Int, Int),CellType], currentPosition : List[Point] = List(),pieceType : CellType = pieceType, newPiece : Boolean = newPiece) : GameState = {

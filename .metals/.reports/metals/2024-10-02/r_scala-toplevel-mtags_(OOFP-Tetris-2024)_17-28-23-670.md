error id: file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala:[6843..6846) in Input.VirtualFile("file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala", "package tetris.logic
...
// use integers to check for specific bound behaviour
    ...
    def moveDown() : GameState = {
        ...
        if(boundCheck(newPieceAbsPos) == 3){
            println("newPiece")
            val linesToRemove : Map[Int, Boolean] = checkAllLines(board)
            val nBoard : Map[Point, CellType] = clearLines(board, linesToRemove)
    ...
    def clearLines(currBoard : Map[Point, CellType], cond : Point => Boolean): Map[Point, CellType] = {
...
file://<HOME>/Uni/2024-2025/Period%201/OOFP/OOFP-Tetris-2024/src/tetris/logic/GameState.scala:166: error: expected identifier; obtained def
    def reloadBoard(currPiecePos : List[Point], currPiece : CellType) : Map[Point, CellType] = {
    ^
#### Short summary: 
